    ...
    return Stack(
      children: [Scaffold(
        ...
        body: Obx(() {
              ...
              if (box == null || imageBox == null || orderBox == null || aiBox == null) {
          ...
          padding: const EdgeInsets.only(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            ListController.isSimpleView.toggle(); // Toggle the view
                          },
                        ),
                      ),
                    ],
                  ...
                  Expanded(
                    child: buildListView(ListController, keys, box, imageBox, aiBox,context)
                  ),
                ],
              );}
  }),
...
Widget buildListView(MyListController ListController, List<dynamic> keys, Box box, Box imageBox, Box aiBox, BuildContext context) {
                        ...
                        // Title
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  placeDetail?['cuisines/styles'] ??  aisummary['Cuisines/Styles'] ?? 'Not Available',
                                  // placeDetail?['cusine'] ?? '',
                                  overflow: TextOverflow.ellipsis,
                                  style: const TextStyle(
                                    color: Colors.black54,
...
Widget simpleListItem(Map<String, dynamic> placeDetail, key, context,placeDetailImages) {
  return InkWell(
    onTap: () {
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => placeInformationScreen(
          placeDetail: placeDetail,
